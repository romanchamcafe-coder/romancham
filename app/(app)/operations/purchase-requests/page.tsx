...
export const metadata: Metadata = pageMetadata({ title: "Purchase Requests", description: "Create and approve vendor purchase requests from low-stock items.", path: "/operations/purchase-requests" });
